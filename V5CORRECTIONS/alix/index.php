    ...
    <div class="container main-container">
		<div class="row"> 
            ...
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12" id="categories">
			  ...
			  <section>
				<h2><a href="handisport.php"> Le handisport, éternel oublié</a></h2> 
				<div class="chapo">
			  ...
			  <section>
				<h2><a href="velo.php">Vélo et auto. Des relations trop dangereuses </a></h2>
				<div class="chapo">  
			   ...
			   <section>
				<h2><a href="veloelectrique.php"> Le vélo électrique, pas si “bobo” </a></h2> 
				<div class="chapo">
