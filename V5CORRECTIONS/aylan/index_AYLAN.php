...
Même si je reste passionné, je suis parfois lassé du manque de moyens financiers, d’infrastructures, et la baisse des adhérents.
            ...
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12" id="categories">
			  ...
			  <section>
				<h2><a href="content_esport.php">E-sport, le faux vainqueur de la crise sanitaire </a></h2>
				<div class="chapo">  
			   ...
			   <section>
				<h2><a href="content_milieurural.php">En milieu rural, les clubs sportifs à la traîne</a></h2> 
				<div class="chapo">
