...
<head>
  <meta charset="utf-8">
  <title>Les visages du sport - Vélo et auto. Des relations trop dangereuses</title>
...
<body id="art" class="alix-cat inside article">
	...
	<?php 
		...
		$titre = "Vélo et auto. Des relations trop dangereuses";
    ...
    <div class="container main-container">
		...
		<div class="col-12">
			...
			<div id="topimage">
			<img src="../img/velo3.jpg" alt="Vélo électrique" />
			<div id="legende">Durant l’été 2020, 1 566 cyclistes ont été accidentés sur la route</div>
			</div>
