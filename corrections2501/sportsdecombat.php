...
<body id="art" class="sasha-cat inside article">
    ...
    <div class="container main-container">
		...
		<div id="details">
			<p> Par Marion Mergault et Maëlenn Nicolas </p>
		...
		<div id="topimage">
			<img src="../img/BoxeF.jpeg" />
			<div id="legende"> Marie Leroy, 20 ans, a renforcé sa confiance en elle grâce à la boxe.</div>
		</div>
            
			<div id="chapo" class="lead"> En France, 86% des femmes affirment avoir été victimes d’agression. Pour apprendre à se défendre et gagner en confiance en soi, elles sont de plus en plus nombreuses à se tourner vers les sports de combat au cours de ces vingt dernières années. Boxe, karaté, judo ou encore self défense, cette augmentation des licenciées se démarque de celle des autres sports.</div> 
