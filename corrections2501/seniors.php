...
<head>
  ...
  <?php require_once('metadata_seniors.php'); ?>
...
<body id="art" class="charlie-cat inside article">
    ...
    <div class="container main-container">
		...
		<div id="topimage">
			<img src="../img/photo_seniors.jpeg" />
			<div id="legende">Les personnes âgées profitent du dimanche matin pour faire du sport face à la mer, à côté de la plage de Trestrignel.</div>
		</div>
            
			<div id="chapo" class="lead">De graves conséquences apparaissent chez les seniors après l’arrêt du sport lors  du confinement. Dans les EHPAD, certains pensionnaires « <I> ont perdu l’habitude de  marcher. Ils tombent </I> ». Le personnel soignant demande des moyens  supplémentaires. .</div>
