		...
		<div class="row">
            ...
            <div class="col col-lg-4 col-md-4 col-sm-6 col-6">
               <div class="cadre">
					...
					<p> J’ai 20 ans. Contrairement à beaucoup de mes amies, je n’ai pas arrêté le sport à mon adolescence. J’ai été agressée par mon entraîneur, mais mon club n’a rien fait. Je n’ai pas voulu tout arrêter, alors j’ai cherché un nouveau sport. J’ai rejoint un club de boxe féminine, en partie pour reprendre confiance en moi.
          </p>
            ...
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12" id="categories">
			  ...
			  <section>
				<h2><a href="sports-de-combat"> Les femmes de plus en plus adeptes de sports de combat </a></h2>
				<div class="chapo">
			  ...
			  <section>
				<h2><a href="violences-sexuelles">Violences sexuelles. À Lannion, la Parole des sportifs se libère</a></h2>
				<div class="chapo">
			   ...
			   <section>
				<h2><a href="lannion-impasse-sport-feminin">À Lannion, l’impasse du sport féminin</a></h2>
				<div class="chapo">
			  ...
			  <section>
				<h2><a href="puberte">La puberté : un coup d’arrêt dans la pratique sportive des adolescentes</a></h2>
				<div class="chapo">
