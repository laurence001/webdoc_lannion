...
<head>
  ...
  <?php require_once('metadata_cancer.php'); ?>
...
<body id="art" class="charlie-cat inside article">
    ...
    <div class="container main-container">
		...
		<div id="topimage">
			<img src="../img/cancer.jpeg" />
			<div id="legende">Avec cinq heures de sport par semaine, 20% des cancers du poumon pourraient être évités.</div>
		</div>
