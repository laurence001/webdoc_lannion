    ...
    <div class="container main-container">
		<div class="row"> 
            ...
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12" id="categories">
			  ...
			  <section>
				<h2><a href="content_cancer.php">Le sport, un remède de taille contre le cancer</a></h2> 
				<div class="chapo">
			  ...
			  <section>
				<h2><a href="content_seniors.php">Les ravages de l’inactivité chez les seniors  </a></h2>
				<div class="chapo">  
