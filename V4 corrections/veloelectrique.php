...
<body id="art" class="alix-cat inside article">
	...
	<?php 
		...
		$titre = "Le velo electrique, pas si bobo";
    ...
    <div class="container main-container">
		...
		<div id="details">
			<p>Koupaïa Rault et Evan Livenais</p>
		...
		<div id="topimage">
			<img src="../img/electrique.jpeg" />
			<div id="legende">Légende de la photo ici</div>
		</div>
            
			<div id="chapo" class="lead">Entre écologie et économie, le vélo électrique tente de se démocratiser dans nos villes. Afin de se débarrasser de la réputation “bobo” dont il souffre, de nombreuses démarches se mettent en place pour permettre à toustes de prendre la roue.</div>
