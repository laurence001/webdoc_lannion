    ...
    <div class="container main-container">
		<div class="row"> 
            ...
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12" id="categories">
			  ...
			  <section>
				<h2><a href="content_sportsdecombat.php"> Les femmes de plus en plus adeptes de sports de combat </a></h2> 
				<div class="chapo">
			  ...
			  <section>
			   ...
			   <section>
				<h2><a href="content_feminisation.php">À Lannion, l’impasse du sport féminin</a></h2> 
				<div class="chapo">
