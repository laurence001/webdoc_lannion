		...
		<div class="row"> 
            ...
            <div class="col col-lg-4 col-md-4 col-sm-6 col-6">
               <div class="cadre">    
					...
					<p> Je suis élu au conseil municipal de ma commune depuis 15 ans. Chargé des sports, j’ai 56 ans et j’ai une pratique assidue de vélo et de natation. Je me bat tous les jours pour développer le budget des associations et clubs sportifs de ma ville.
Même si je reste passionné, je suis parfois lassé du manque de moyens financiers, d’infrastructures, et la baisse des adhérents.
 </p>
            ...
            <div class="col col-lg-6 col-md-6 col-sm-12 col-12" id="categories">
			  ...
			  <section>
				<h2><a href="quartierspopulaires">Les clubs et la Covid-19, une relation qui s’essoufle </a></h2> 
				<div class="chapo">
			  ...
			  <section>
				<h2><a href="riche">E-sport, le faux vainqueur de la crise sanitaire </a></h2>
				<div class="chapo">  
					L’e-sport grand gagnant du confinement ? En apparence, le secteur compétition du jeu vidéo semble avoir été l’un des rares à profiter de la crise sanitaire. Habituée au 100% “online”, la discipline a bénéficié d’une plus grande visibilité.  Néanmoins, l’annulation des événements physiques a paralysé une partie des financements de l’e-sport. 
				</div>
			   </section>
			   
			   <section>
				<h2><a href="quartierspopulaires">En milieu rural, les clubs sportifs à la traîne</a></h2> 
				<div class="chapo">
					Les milieux ruraux ont du mal à pérenniser leurs activités sportives, faute de moyens et d’infrastructure. Les Côtes-d’Armor n'échappent pas à cette règle : les financements et solutions apportés aux clubs de sport ne sont pas suffisants… et ceux-ci disparaissent.
				</div> 
			  </section>
